...
test(
    "Test-toRdfSocialAgentRegistration-c4562da9", async () => {
        ...
        let actual = await new RdfFactory().create(ExampleInstances.socialAgentRegistrationc4562da9)
...
test(
    "Test-toRdfApplicationRegistration-2f2f3628", async () => {
        ...
        let actual = await new RdfFactory().create(ExampleInstances.applicationRegistration2f2f3628)
...
test.each([
    { name: 'd577d117', expect_rdf_file_path: "authorization/d577d117AccessAuthorization.ttl", instance: ExampleInstances.accessAuthorizationd577d117 },
