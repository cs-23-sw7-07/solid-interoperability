...
test('AccessAuth-to-AccessGrant', async (path = join(PATH_TO_RDFS_EXAMPLES, "authorization/47e07897AccessAuth.ttl")) => {
    ...
    const content = await factory.create(actual.toAccessGrant("https://alice.example/authorization/47e07897", [ExampleInstances.dataGrant40d038ea]))
